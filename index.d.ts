 ...
 */
export declare function get_table_deltas(code: string, scope: string, table_name: string, options?: {
    req_id?: string;
    start_block?: number;
    fetch?: boolean;
}): string;
 ...
 */
export declare function parse_table_deltas<T>(data: WebSocketData, req_id?: string): TableDelta<T> | null;
/**
